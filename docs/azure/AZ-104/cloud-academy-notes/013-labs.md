# In this lab
- used pre-created vm (srv)
- used powerscript to:
  - create AD
  - create Apps Registration (sorta like an IAM Role)
  - create KeyVault (with permission granted to the above created)
  - create Key encryption key
  - create BitLocker encryption Key
  - creates a VM (vm1)
  - deploy an encrypt extension to vm1 
    - script installs and activates bitlocker
    - requires restart of the vm to encrypt the OS disk


https://docs.microsoft.com/en-us/azure/security/fundamentals/azure-disk-encryption-vms-vmss
http://www.deployazure.com/security/key-vault/azure-disk-encryption-recover-bitlocker/
...
Add-AzAccount -SubscriptionId "3555dde6-72a3-47a0-8305-ad3715fb42c3" 


$ResourceGroupName = "cal-1621-61"
$VMName = "EncryptWin1"
